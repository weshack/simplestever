...
// var getChanges = function(client, cursor, changes, keepPulling) {



// 	if (keepPulling) {
// 		client.delta(cursor, function(error, changed) {
// 			return getChanges(client, changed.cursorTag, changes.concat(changed.changes), changed.shouldPullAgain);
// 		});
// 	}
...
// var getChanges = function(client, cursor, changes, keepPulling, callback){
// 	keepPulling = true;
// 	changes = [];
//  	if (keepPulling){
//  		client.delta(cursor, function(error, changed){
//  			getChanges(client, changed.cursorTag, changes.concat(changed.changes), changed.shouldPullAgain);
//  		});
//  	}
...
exports.authenticate = function(req, res) {
	...
	client.authenticate(function(error, cl) {
		...
		// cl.delta(function(error, changed){
		// 	console.log(changed);
		// });
		// console.log(getChanges(cl, null, [], true));
	// });
